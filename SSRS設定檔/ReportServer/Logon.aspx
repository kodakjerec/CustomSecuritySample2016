...
<HTML>
   ...
   <body MS_POSITIONING="GridLayout">
      <form id="Form1" method="post" runat="server">
         ...
         <asp:Button id="BtnLogon" style="Z-INDEX: 106; LEFT: 352px; POSITION: absolute; TOP: 312px"
         ...
         <asp:TextBox id="TxtPwd" style="Z-INDEX: 103; LEFT: 296px; POSITION: absolute; TOP: 184px" runat="server"
            tabIndex="2" Width="160px" TextMode="Password" Text="p@ssw0rD" meta:resourcekey="TxtPwdResource1"></asp:TextBox>
         <asp:Label id="LblPwd" style="Z-INDEX: 102; LEFT: 176px; POSITION: absolute; TOP: 192px" runat="server"
          ...
          <asp:Label id="Label2" style="Z-INDEX: 102; LEFT: 176px; POSITION: absolute; TOP: 232px" runat="server"
            Width="96px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="LblPwdResource1">PasswordHash:</asp:Label>&nbsp;
          <asp:Label id="Label3" style="Z-INDEX: 102; LEFT: 176px; POSITION: absolute; TOP: 272px" runat="server"
            Width="96px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="LblPwdResource1">Salt:</asp:Label>&nbsp;
         <asp:TextBox id="TxtUser" style="Z-INDEX: 104; LEFT: 296px; POSITION: absolute; TOP: 152px" runat="server"
            tabIndex="1" Width="160px" Text="administrator" meta:resourcekey="TxtUserResource1"></asp:TextBox>
         <asp:Button id="BtnRegister" style="Z-INDEX: 105; LEFT: 232px; POSITION: absolute; TOP: 312px"
            runat="server" Width="104px" Text="Register User" tabIndex="4" meta:resourcekey="BtnRegisterResource1"></asp:Button>
         <asp:Label id="lblMessage" style="Z-INDEX: 107; LEFT: 168px; POSITION: absolute; TOP: 352px"
         ...
         <asp:Label id="Label1" style="Z-INDEX: 108; LEFT: 120px; POSITION: absolute; TOP: 96px" runat="server"
          ...
          <asp:Label ID="lblPwdHash" runat="server" style="Z-INDEX: 102; LEFT: 316px; POSITION: absolute; TOP: 232px" runat="server"
            Width="96px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="lblMessageResource1"></asp:Label>
          <asp:Label ID="lblSalt" runat="server" style="Z-INDEX: 102; LEFT: 316px; POSITION: absolute; TOP: 272px" runat="server"
            Width="96px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="lblMessageResource1"></asp:Label>
          </p>
      </form>
   </body>
